...
export interface ApiContributionContribution extends Schema.CollectionType {
  ...
  attributes: {
    publicationDatetime: Attribute.DateTime;
...
export interface ApiLinkLink extends Schema.CollectionType {
  ...
  attributes: {
    ...
    child: Attribute.Relation<
      ...
      'api::contribution.contribution'
    >;
    isFirstLink: Attribute.Boolean & Attribute.DefaultTo<false>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiUserContextUserContext extends Schema.CollectionType {
  collectionName: 'user_contexts';
  info: {
    singularName: 'user-context';
    pluralName: 'user-contexts';
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::user-context.user-context': ApiUserContextUserContext;
    }
  }
}
